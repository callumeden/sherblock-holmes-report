...
\section{Bitcoin Address Types}\label{background-address-types}
A bitcoin address may begin with a 1, a 3 or a bc1 which distinguishes between different types of addresses. A bitcoin address beginning with 1 indicates a Pay-to-PubKey-Hash address. An address beginning with 3 indicates a Pay-to-Script-Hahs address. Addresses beginning with bc1 are a Bech32 type address (a segregated-witness address) \cite{RefWorks:doc:5c39e80ae4b0854ae611b047}.

\section{Vanity Addresses}\label{background-vanity-addresses}
